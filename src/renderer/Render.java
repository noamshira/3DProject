...
public class Render {
	...
	/**
	 * setter to the option of using softShadows
	 *
	 * @param softShadows true to use softShadows
	 * @return renderer itself for chaining
	 */
	public Render setSoftShadows(boolean softShadows) {
		tracer.setSoftShadows(softShadows);
		return this;
	}

	/**
	 * setter for the square root of the ray in the beam of the soft shadow
	 *
	 * @param n the square root of the ray in the beam of the soft shadow
	 * @return renderer itself for chaining
	 */
	public Render setSqrtBeamNum(int n) {
		tracer.setSqrtBeamNum(n);
		return this;
	}

	/**
	 * setter for the option of using Adaptive supersampling
	 *
	...
	public Render setAdaptiveSuperSampling(boolean adaptiveSuperSampling) {
		tracer.setAdaptiveSuperSampling(adaptiveSuperSampling);
		return this;
	}
