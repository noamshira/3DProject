...
@Test
	...
	/**
	 * Produce a picture of a two triangles lighted by a spot light direction light and point light
	 */
	@Test
	public void trianglesMultiLights() {
		scene2.geometries.add(triangle1.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)), //
				triangle2.setMaterial(new Material().setKd(0.5).setKs(0.5).setShininess(300)));
		scene2.lights.add(new PointLight(new Color(500, 250, 50), new Point3D(10, -50, -130)) //
				.setKl(0.0005).setKq(0.005));
		scene2.lights.add(new SpotLight(new Color(100, 350, 50), new Point3D(10, -10, -130), new Vector(2, 2, 1)) //
				.setKl(0.000000001).setKq(0.000000005));
		scene2.lights.add(new DirectionalLight(new Color(160, 55, 605), new Vector(-20, 10, 10)));

		ImageWriter imageWriter = new ImageWriter("lightTrianglesMultiLights", 500, 500);
		Render render = new Render()//
				.setImageWriter(imageWriter) //
				.setCamera(camera2) //
				.setRayTracer(new RayTracerBasic(scene2));
	...
	/**
	 * Produce a picture of a sphere lighted by a spot light direction light and point light
	 */
	@Test
	public void sphereMultiLights() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new DirectionalLight(new Color(500, 0, 0), new Vector(-10, -51, 10)));
		scene1.lights.add(new SpotLight(new Color(300, 100, 0), new Point3D(-50, -150, 50), new Vector(1, 11, -2)) //
				.setKl(0.001).setKq(0.000001));
		scene1.lights.add(new PointLight(new Color(200, 300, 50), new Point3D(-50, 50, 50))//
				.setKl(0.0001).setKq(0.00001));

		ImageWriter imageWriter = new ImageWriter("lightSphereDirectionalMultiLights", 500, 500);
		Render render = new Render()//
				.setImageWriter(imageWriter) //
				.setCamera(camera1) //
				.setRayTracer(new RayTracerBasic(scene1));
