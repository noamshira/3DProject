...
class SphereTests {
    ...
    void findIntsersections() {
        ...
        assertNull(sphere.findIntersections(new Ray(new Point3D(0, 0, 0), new Vector(-1, 0, 0))));
        ...
        assertNull(sphere.findIntersections(new Ray(new Point3D(0, -1, 0), new Vector(0, 1, 0))));
        ...
        assertNull(sphere.findIntersections(new Ray(new Point3D(-1, 0, 0), new Vector(0, 1, 0))));
